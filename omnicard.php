<?php
/*
Plugin Name: OmniKassa for WooCommerce Lite
Plugin URI: https://ajdg.solutions/?utm_campaign=homepage&utm_medium=plugin-info&utm_source=omnikassa-lite
Author: Arnan de Gans from AJdG Solutions
Author URI: http://meandmymac.net/?utm_campaign=homepage&utm_medium=plugin-info&utm_source=omnikassa-lite
Description: A fully integrated and easy to use payment gateway for WooCommerce. Accept iDeal, Bancontact/Mistercash and Credit Cards with ease using Omnikassa for WooCommerce.
...
function omnicard_notifications_dashboard() {
	...
	echo '	<div class="omnicard_notification">';
	echo '		<div class="button_div"><a class="button" target="_blank" href="'.site_url().'/wp-admin/plugin-install.php?s=omnikassa+arnan&tab=search&type=term">'.__('Install now!', 'omnicard-lite').'</a></div>';
	echo '		<div class="text">'.__("If you enjoy Omnikassa for WooCommerce please switch to the full version for FREE!", 'omnicard-lite').'<br /><span>'.__("The new plugin will continue to receive updates and supports more payment methods!", 'omnicard-lite').' <a target="_blank" href="https://ajdg.solutions/products/omnikassa-for-woocommerce/">'.__('Visit website', 'omnicard-lite').' &raquo;</a></span></div>';
	echo '	  	<div class="icon"><img title="Logo" src="'.plugins_url('/images/omnikassa-logo.jpg', __FILE__).'" alt="" width="60" /></div>';
	echo '	</div>';
	echo '</div>';
	...
	echo '			<a class="button" target="_blank" href="'.site_url().'/wp-admin/plugin-install.php?s=omnikassa&tab=search&type=term">'.__('Switch now!', 'omnicard-lite').'</a>';
		echo '		</div>';
